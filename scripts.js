...
function changeLanguage(lang) {
    // सभी भाषा बटन से active क्लास हटाएं
    langButtons.forEach(btn => btn.classList.remove('active'));
    // वर्तमान भाषा बटन पर active क्लास जोड़ें
    document.querySelector(`.lang-btn[data-lang="${lang}"]`).classList.add('active');
    
    // सभी ट्रांसलेटेबल एलिमेंट्स को अपडेट करें
...
// डिफॉल्ट भाषा सेट करें (हिंदी)
changeLanguage('hi');

// फॉर्म सबमिशन
document.getElementById('pujaBookingForm').addEventListener('submit', function(e) {
    e.preventDefault();
    alert('आपकी पूजा बुकिंग सफलतापूर्वक सबमिट हो गई है। हम जल्द ही आपसे संपर्क करेंगे।');
    this.reset();
});
